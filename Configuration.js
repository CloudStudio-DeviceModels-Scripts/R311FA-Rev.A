...
function getEndpoints(deviceAddress, endpoints) {
    ...
    var velocityx = endpoints.addEndpoint("3", "Velocity X", endpointType.genericSensor);
    velocityx.variableTypeId = 1281;
    var velocityy = endpoints.addEndpoint("4", "Velocity Y", endpointType.genericSensor);
    velocityy.variableTypeId = 1281;
    var velocityz = endpoints.addEndpoint("5", "Velocity Z", endpointType.genericSensor);
